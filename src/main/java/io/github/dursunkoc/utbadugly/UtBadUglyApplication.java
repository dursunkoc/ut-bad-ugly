...
public class UtBadUglyApplication implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        jdbc.execute("CREATE TABLE IF NOT EXISTS warehouse (id INT PRIMARY KEY, product_id int, location VARCHAR(255), stock INT)");
        jdbc.execute("CREATE TABLE IF NOT EXISTS orders (id INT PRIMARY KEY AUTO_INCREMENT, customer_id INT, product_id INT, quantity INT, paid BOOLEAN, shipped BOOLEAN)");
        ...
        jdbc.execute("MERGE INTO warehouse (id, product_id, location, stock) KEY(id) VALUES (1, 1, 'Main Warehouse', 100)");
