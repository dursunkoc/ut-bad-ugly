...
public class UtBadUglyApplication implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        jdbc.execute("CREATE TABLE IF NOT EXISTS product_shipment_code (product_id INT, city VARCHAR(255), shipment_code VARCHAR(255), PRIMARY KEY(product_id, city))");
        ...
        jdbc.execute("MERGE INTO product_shipment_code (product_id, city, shipment_code) KEY(product_id, city) VALUES (1, 'Istanbul', 'SHIP-IST-001')");
    }
}
